...
_REPOCOMMANDRESPONSEMESSAGE_REPOCOMMANDRESPONSE = descriptor.Descriptor(
  ...
  full_name='RepoCommandResponseMessage.RepoCommandResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='process_id', full_name='RepoCommandResponseMessage.RepoCommandResponse.process_id', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='status_code', full_name='RepoCommandResponseMessage.RepoCommandResponse.status_code', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='start_block_id', full_name='RepoCommandResponseMessage.RepoCommandResponse.start_block_id', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='end_block_id', full_name='RepoCommandResponseMessage.RepoCommandResponse.end_block_id', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='insert_num', full_name='RepoCommandResponseMessage.RepoCommandResponse.insert_num', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='delete_num', full_name='RepoCommandResponseMessage.RepoCommandResponse.delete_num', index=5,
...
_REPOCOMMANDRESPONSEMESSAGE = descriptor.Descriptor(
  ...
  full_name='RepoCommandResponseMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='repo_command_response', full_name='RepoCommandResponseMessage.repo_command_response', index=0,
...
class RepoCommandResponseMessage(message.Message):
  ...
  class RepoCommandResponse(message.Message):
    ...
    # @@protoc_insertion_point(class_scope:RepoCommandResponseMessage.RepoCommandResponse)
  DESCRIPTOR = _REPOCOMMANDRESPONSEMESSAGE
  
  # @@protoc_insertion_point(class_scope:RepoCommandResponseMessage)
